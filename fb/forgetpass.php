...
<div id="mids">
	<div id="midd">
    	<div id="middt">
            ...
            <hr>
                <div id="middt1">
                    <p align="center" style="line-height:30px;">Email, Phone, Username or Full Name</p>
                    
                    <div id="middtl" style="font-size:25px; line-height:35px;"><i class="fa fa-envelope"></i></div>
                    <div id="middtr"><input type="text" name="femail" style="margin-top:7px;"></div>
        ...
        <div id="middb">
            ...
            <div id="middbr"><input type="submit" value="Search"> <input type="reset" value="Cancel"></div>
        </div>
    </div>
</div>
</form>
